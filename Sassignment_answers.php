...
<?php
    ...
    { 
       ...
       $stmt_fetch_videos = $conn->prepare("SELECT name, title, pdf, created_at FROM educational_student_assignment WHERE subject = ? ORDER BY created_at DESC");
               ...
               if($stmt_fetch_videos->execute())
               {
                   ...
                   while ($row = $result->fetch_assoc()) 
                   {
                       ...
                       <div class="control-div">
                           <p><span style = "font-weight : bold;">Name :</span> '.$row["name"].'</p>
