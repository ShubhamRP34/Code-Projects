...
<?php
    ...
    { 
       ...
       $stmt_fetch_videos = $conn->prepare("SELECT title, description, pdf, created_at , lastdate FROM educational_assignment WHERE subject = ? ORDER BY created_at DESC");
               ...
               if($stmt_fetch_videos->execute())
               {
                   ...
                   while ($row = $result->fetch_assoc()) 
                   {
                       ...
                       <div class="control-div">
                           ...
                           <embed class = "content-div" id = "content" src="'.$row["pdf"].'" type="application/pdf" width="850" height="480">
                           <div style = "border: 1px solid black; margin-left: 5px; margin-right: 5px;"></div>
                           ...
                           <p><span style = "font-weight : bold;">Dead Line :</span> <span style = "color : red; font-weight : bold;">'.$row["lastdate"].'</span></p>
                       </div>
                       </div>
                       ';
                   }
